        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="#" className="hover:text-primary transition">Forex Fraud Recovery</Link></li>
              <li><Link href="#" className="hover:text-primary transition">Crypto Scam Recovery</Link></li>
              <li><Link href="#" className="hover:text-primary transition">Binary Options Recovery</Link></li>
              <li><Link href="#" className="hover:text-primary transition">Trading Platform Fraud</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-primary transition">Success Stories</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-primary transition">Certifications</Link></li>
            </ul>
          </div>
        </div>
